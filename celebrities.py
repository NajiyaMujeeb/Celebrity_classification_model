...
image_dir = r'C:\Users\hp\Desktop\DL Assignment 2\Dataset_Celebrities\cropped'
lionel_messi = os.listdir(r'C:\Users\hp\Desktop\DL Assignment 2\Dataset_Celebrities\cropped\lionel_messi')
maria_sharapova = os.listdir(r'C:\Users\hp\Desktop\DL Assignment 2\Dataset_Celebrities\cropped\maria_sharapova')
roger_federer = os.listdir(r'C:\Users\hp\Desktop\DL Assignment 2\Dataset_Celebrities\cropped\roger_federer')
serena_williams = os.listdir(r'C:\Users\hp\Desktop\DL Assignment 2\Dataset_Celebrities\cropped\serena_williams')
virat_kohli = os.listdir(r'C:\Users\hp\Desktop\DL Assignment 2\Dataset_Celebrities\cropped\virat_kohli')
print("---------------------------------------------------")
...
print(make_prediction('Dataset_Celebrities\cropped\maria_sharapova\maria_sharapova1.png',model))
print('--------------------------------------------------------')